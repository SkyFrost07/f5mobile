...
class es_cls_registerhook {
	...
	public static function es_load_widget_scripts_styles() {
		...
		$es_select_params = array(
			'es_email_notice'       => _x( 'Vui lòng nhập địa chỉ email', 'widget-enhanced-select', ES_TDOMAIN ),
			'es_incorrect_email'    => _x( 'Vui lòng nhập email hợp lệ', 'widget-enhanced-select', ES_TDOMAIN ),
			'es_load_more'          => _x( 'Đang tải...', 'widget-enhanced-select', ES_TDOMAIN ),
			'es_ajax_error'         => _x( 'Cannot create XMLHTTP instance', 'widget-enhanced-select', ES_TDOMAIN ),
			'es_success_message'    => _x( 'Đăng ký nhậ bản tin thành công.', 'widget-enhanced-select', ES_TDOMAIN ),
			'es_success_notice'     => _x( 'Bạn đã đăng ký nhận bản tin thành công, vui lòng kiểm tra email để xác nhận!', 'widget-enhanced-select', ES_TDOMAIN ),
			'es_email_exists'       => _x( 'Địa chỉ email đã được đăng ký!', 'widget-enhanced-select', ES_TDOMAIN ),
			'es_error'              => _x( 'Oops.. Có lỗi xảy ra, vui lòng thử lại sau.', 'widget-enhanced-select', ES_TDOMAIN ),
			'es_invalid_email'      => _x( 'Email không hợp lệ', 'widget-enhanced-select', ES_TDOMAIN ),
			'es_try_later'          => _x( 'Vui lòng thử lại sau', 'widget-enhanced-select', ES_TDOMAIN ),
			'es_problem_request'    => _x( 'Có lỗi xảy ra, vui lòng thử lại sau!', 'widget-enhanced-select', ES_TDOMAIN )
		);
		...
		$es_select_params = array(
			'es_email_notice'       => _x( 'Vui lòng nhập địa chỉ email', 'widget-page-enhanced-select', ES_TDOMAIN ),
			'es_incorrect_email'    => _x( 'Vui lòng nhập email hợp lệ', 'widget-page-enhanced-select', ES_TDOMAIN ),
			'es_load_more'          => _x( 'Đang tải...', 'widget-page-enhanced-select', ES_TDOMAIN ),
			'es_ajax_error'         => _x( 'Cannot create XMLHTTP instance', 'widget-page-enhanced-select', ES_TDOMAIN ),
			'es_success_message'    => _x( 'Đăng ký nhậ bản tin thành công.', 'widget-page-enhanced-select', ES_TDOMAIN ),
			'es_success_notice'     => _x( 'Bạn đã đăng ký nhận bản tin thành công, vui lòng kiểm tra email để xác nhận!', 'widget-page-enhanced-select', ES_TDOMAIN ),
			'es_email_exists'       => _x( 'Địa chỉ email đã được đăng ký!', 'widget-page-enhanced-select', ES_TDOMAIN ),
			'es_error'              => _x( 'Oops.. Có lỗi xảy ra, vui lòng thử lại sau.', 'widget-page-enhanced-select', ES_TDOMAIN ),
			'es_invalid_email'      => _x( 'Email không hợp lệ', 'widget-page-enhanced-select', ES_TDOMAIN ),
			'es_try_later'          => _x( 'Vui lòng thử lại sau', 'widget-page-enhanced-select', ES_TDOMAIN ),
			'es_problem_request'    => _x( 'Có lỗi xảy ra, vui lòng thử lại sau!', 'widget-page-enhanced-select', ES_TDOMAIN )
		);
